...
/// Polar org is live, customers still go through
/// `MacPeelLicenseChecker.verify` exactly as before; this is purely a
/// second, narrower door that only opens for whoever already has the one
/// string that hashes to this value.
enum OwnerAccess {
    private static let overrideKeyHash =
        "eafa7a32f03c729f519e78a5711549aaf8cfc22a442cd604b1cebfd3bab2a26e"
